...
use crate::processor::instruction::{
    ALUType, AddrMode, ControlType, InstrType, InterruptType, MemoryType,
};
...
fn parse_line(input: &str) -> u32 {
    ...
    let (remaining, instr_type) =
        alt((parse_alu, parse_memory, parse_control, parse_interrupt))(&input).unwrap();
